            ...
            if (N.Nodes.Count <= 0)
            {
                ...
                switch (Cesta.Length)
                {
                    ...
                    case 1:
                        ...
                        querry = await Load.API<TeZakHodnota>("api/TeZak/Projekt/" + N.Text);
                    ...
                    case 2:
                        ...
                        querry = await Load.APISaveDatabase<TeZakHodnota>("api/TeZak/Task", teZak);
                        foreach (TeZakHodnota item in querry)
                ...
                var data = await Load.APISaveDatabase<TeZak>("api/TeZak/kriteria", teZak);
